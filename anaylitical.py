...
class ComsolProcess(object):
    ...
    def guide(self, x, y_obs):
        ...
        rho_std_q = pyro.param("rho_std_guide", torch.tensor(0.05), constraint=constraints.positive)
        ...
        E_std_q = pyro.param("E_std_guide", torch.tensor(0.05), constraint=constraints.positive)
